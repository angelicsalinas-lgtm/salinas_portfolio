        ...
        <div className={styles.content}>
          <div className={styles.info}>
            ...
            <p className={styles.description}>
              ...
              Whether you need branding, illustrations, or experimental 
              design work—let&apos;s create something meaningful together.
            </p>
            
            <div className={styles.socials}>
              <a href="#" className={styles.socialLink} aria-label="Behance">
